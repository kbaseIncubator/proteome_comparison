...
function GenomeProteomeComparison(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.blast_proteomes = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeProteomeComparison.blast_proteomes",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeProteomeComparison.status",
