...
class GenomeComparison(object):
    ...
    def blast_proteomes(self, input, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method blast_proteomes: argument json_rpc_context is not type dict as required.')
        resp = self._call('GenomeComparison.blast_proteomes',
